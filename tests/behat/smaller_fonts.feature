...
Feature: Change font size and colour in TinyMCE using the Smaller fonts plugin
  In order to emphasise or de-emphasise text
  As a user
  I need to be able to change the font size and colour of selected text
  ...
  Scenario: Font colour button applies the configured colour to selected text
    Given I log in as "admin"
    And I open my profile in edit mode
    And I set the field "Description" to "<p>Some sample text</p>"
    And I expand all toolbars for the "Description" TinyMCE editor
    And I select the "p" element in position "0" of the "Description" TinyMCE editor
    When I click on the "Font colour" button for the "Description" TinyMCE editor
    And I click on "Red" "text"
    And I switch to the "Description" TinyMCE editor iframe
    Then the "style" attribute of "Some sample text" "text" should contain "color"
  ...
  Scenario: Permissions can be configured to control access to the font size picker
    ...
    And "Font colour" button should not exist in the "Activity instructions" TinyMCE editor
    ...
    And "Font colour" button should exist in the "Activity instructions" TinyMCE editor
